...
ouo=True
keyboard.add_hotkey("f4", lambda: stop2())
def stop2():
    global ouo
    ouo = not ouo
    print(ouo)
...
while ouo:
    ...
    for license_plate in license_plates.boxes.data.tolist():
        ...
        license_plate_text=pytesseract.image_to_string(license_plate_crop_thresh)
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            # if license_plate_text is not None:qq
